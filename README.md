...
### Player Commands
    ...
    /ep broadcast                 Broadcasts your pearl's location to another player
...
### Permissions
  * The player commands are enabled for all players
  * The admin commands are enabled for the permission 'exilepearl.admin'
