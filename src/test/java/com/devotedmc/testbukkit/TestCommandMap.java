...
public class TestCommandMap implements CommandMap {
    private static final Pattern PATTERN_ON_SPACE = Pattern.compile(" ", Pattern.LITERAL);
    protected final Map<String, Command> knownCommands = new HashMap<String, Command>();
    private final Server server;
    
    public boolean lastExecuteResult = false;

    public TestCommandMap(final Server server) {
        this.server = server;
        setDefaultCommands();
    }
     ...
     */
    private boolean register(String label, Command command, boolean isAlias, String fallbackPrefix) {
    ...
    public boolean dispatch(CommandSender sender, String commandLine) throws CommandException {
        ...
        try {
            ...
            lastExecuteResult = target.execute(sender, sentCommandLabel, Arrays.copyOfRange(args, 1, args.length));
